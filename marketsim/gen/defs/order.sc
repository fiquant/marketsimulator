...
package order
{
    ...
    def WithExpiry(/** underlying orders to create */
                   proto    = Limit(),
                   /** expiration period for orders */
                   expiry   = constant(10.)) : IOrderGenerator
    ...
    def Iceberg(/** underlying orders to create */
                proto   = Limit(),
                /** maximal size of order to send */
                lotSize = constant(10.)) : IOrderGenerator
    ...
    def FloatingPrice(/** underlying orders to create */
                      proto = price.Limit(),
                      /** observable defining price of orders to create */
                      floatingPrice = const(10.)) : IOrderGenerator
