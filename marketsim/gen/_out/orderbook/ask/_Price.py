...
class Price(Observable[Price]):""" 
    ...
    def __repr__(self):return "Ask_{%(book)s}" % self.__dict__
    
    _internals = ['impl']
    def getImpl(self):from marketsim.gen._out.orderbook._BestPrice import BestPrice as _orderbook_BestPrice
