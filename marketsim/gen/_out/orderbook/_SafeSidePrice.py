...
class SafeSidePrice_IOrderQueueIObservableFloat(Observablefloat):
    ...
    def __init__(self, queue = None, defaultValue = None):
        ...
        self.defaultValue = defaultValue if defaultValue is not None else call(_const_Float,100.0)
    ...
    def getImpl(self):
        ...
        return call(_IfDefined_IObservableFloatIObservableFloat,call(_orderbook_BestPrice_IOrderQueue,self.queue),call(_IfDefined_IObservableFloatIObservableFloat,call(_orderbook_LastPrice_IOrderQueue,self.queue),self.defaultValue))
...
class SafeSidePrice_IOrderQueueFloat(Observablefloat):
    ...
    def __init__(self, queue = None, defaultValue = None):
        ...
        Observablefloat.__init__(self)
        self.queue = queue if queue is not None else call(_orderbook_Asks_IOrderBook,)
        self.defaultValue = defaultValue if defaultValue is not None else call(_constant_Float,100.0)
        rtti.check_fields(self)
        self.impl = self.getImpl()
        event.subscribe(self.impl, _(self).fire, self)
    ...
    def getImpl(self):
        ...
        from marketsim.gen._out.orderbook._lastprice import LastPrice_IOrderQueue as _orderbook_LastPrice_IOrderQueue
        from marketsim.gen._out._ifdefined import IfDefined_IObservableFloatIObservableFloat as _IfDefined_IObservableFloatIObservableFloat
        return call(_IfDefined_IObservableFloatIObservableFloat,call(_orderbook_BestPrice_IOrderQueue,self.queue),call(_IfDefined_IObservableFloatFloat,call(_orderbook_LastPrice_IOrderQueue,self.queue),self.defaultValue))
