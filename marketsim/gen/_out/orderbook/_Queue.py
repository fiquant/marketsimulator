...
class Queue(_Queue_Impl):""" 
    """ 
    def __init__(self, book = None, side = None):from marketsim.gen._out.orderbook._OfTrader import OfTrader as _orderbook_OfTrader
    ...
    def __repr__(self):return "Queue(%(book)s, %(side)s)" % self.__dict__
