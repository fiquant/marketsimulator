...
class LastTradeVolume(_LastTradeVolume_Impl):"""   Returns None if there haven't been any trades
    """ 
    ...
    def __repr__(self):return "LastTradeVolume(%(queue)s)" % self.__dict__
