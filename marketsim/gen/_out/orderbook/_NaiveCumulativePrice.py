...
class NaiveCumulativePrice_IOrderBookFloat(Observable[float]):
    ...
    def getImpl(self):
        ...
        from marketsim.gen._out.orderbook.bid._price import Price_IOrderBook as _orderbook_bid_Price_IOrderBook
        return _ops_Condition_BooleanIObservableFloatIObservableFloat(_ops_Less_FloatFloat(self.depth,_constant_Float(0.0)),_ops_Mul_FloatIObservableFloat(self.depth,_orderbook_ask_Price_IOrderBook(self.book)),_ops_Condition_BooleanIObservableFloatFloat(_ops_Greater_FloatFloat(self.depth,_constant_Float(0.0)),_ops_Mul_FloatIObservableFloat(self.depth,_orderbook_bid_Price_IOrderBook(self.book)),_constant_Float(0.0)))
