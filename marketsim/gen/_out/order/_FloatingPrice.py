...
class FloatingPrice(IOrderGenerator, Factory_Impl):""" 
    ...
    """ 
    def __init__(self, floatingPrice = None, proto = None):from marketsim.gen._intrinsic.order.meta.floating_price import Factory_Impl
        ...
        if isinstance(floatingPrice, types.IEvent):event.subscribe(self.floatingPrice, self.fire, self)
    ...
    def __repr__(self):return "FloatingPrice(%(floatingPrice)s, %(proto)s)" % self.__dict__
