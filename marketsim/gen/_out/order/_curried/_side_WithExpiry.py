...
IFunction[IOrderGenerator,IFunction[Side]]):""" 
    ...
    def __repr__(self):return "side_WithExpiry(%(expiry)s, %(proto)s)" % self.__dict__
    
    def __call__(self, side = None):from marketsim.gen._out.order._WithExpiry import WithExpiry
        expiry = self.expiry
        proto = self.proto
