...
class price_StopLoss_IFunctionFloatFloatIOrderGenerator(IFunction[IOrderGenerator,IFunction[float]]):
    """ 
...
def price_StopLoss(maxloss = None,proto = None): 
    ...
    raise Exception('Cannot find suitable overload for price_StopLoss('+str(maxloss)+','+str(proto)+')')
