...
IFunction[IOrderGenerator,IFunction[float]]):""" 
    ...
    def __repr__(self):return "price_StopLoss(%(maxloss)s, %(proto)s)" % self.__dict__
    
    def __call__(self, price = None):from marketsim.gen._out.order._StopLoss import StopLoss
