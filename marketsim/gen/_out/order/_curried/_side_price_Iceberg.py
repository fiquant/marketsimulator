...
IFunction[IFunction[IOrderGenerator,IFunction[float]],IFunction[Side]]):""" 
    ...
    def __repr__(self):return "side_price_Iceberg(%(lotSize)s, %(proto)s)" % self.__dict__
    
    def __call__(self, side = None):from marketsim.gen._out.order._curried._price_Iceberg import price_Iceberg
