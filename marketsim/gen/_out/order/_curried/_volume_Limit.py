...
class volume_Limit(IFunction[IOrderGenerator, IFunction[float]]):""" 
    ...
    """ 
    def __init__(self, side = None, price = None):from marketsim.gen._out.side._Sell import Sell as _side_Sell
    ...
    def __repr__(self):return "volume_Limit(%(side)s, %(price)s)" % self.__dict__
