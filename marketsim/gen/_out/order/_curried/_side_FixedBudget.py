...
class side_FixedBudget(IFunction[IOrderGenerator, IFunction[Side]
    ...
    """ 
    def __init__(self, budget = None):from marketsim.gen._out._constant import constant as _constant
    ...
    _properties = {'budget' : IFunction[float]
    }
    def __repr__(self):return "side_FixedBudget(%(budget)s)" % self.__dict__
