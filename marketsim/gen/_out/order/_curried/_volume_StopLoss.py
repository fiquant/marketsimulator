...
IFunction[IOrderGenerator,IFunction[float]]):""" 
    ...
    def __repr__(self):return "volume_StopLoss(%(maxloss)s, %(proto)s)" % self.__dict__
    
    def __call__(self, volume = None):from marketsim.gen._out.order._StopLoss import StopLoss
