def StopLoss(maxloss = None,proto = None): 
    ...
    from marketsim.gen._out.order._curried._sideprice_stoploss import sideprice_StopLoss_FloatSideFloatIObservableIOrder as _order__curried_sideprice_StopLoss_FloatSideFloatIObservableIOrder
    ...
    if maxloss is None or rtti.can_be_casted(maxloss, IFunctionfloat):
        if proto is None or rtti.can_be_casted(proto, IFunctionIObservableIOrderIFunctionSideIFunctionfloat):
            return _order__curried_sideprice_StopLoss_FloatSideFloatIObservableIOrder(maxloss,proto)
