def Iceberg(lotSize = None,proto = None): 
    ...
    from marketsim.gen._out.order._curried._sideprice_iceberg import sideprice_Iceberg_FloatSideFloatIObservableIOrder as _order__curried_sideprice_Iceberg_FloatSideFloatIObservableIOrder
    ...
    if lotSize is None or rtti.can_be_casted(lotSize, IFunctionfloat):
        if proto is None or rtti.can_be_casted(proto, IFunctionIObservableIOrderIFunctionSideIFunctionfloat):
            return _order__curried_sideprice_Iceberg_FloatSideFloatIObservableIOrder(lotSize,proto)
