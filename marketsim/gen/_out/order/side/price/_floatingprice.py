def FloatingPrice(floatingPrice = None,proto = None): 
    ...
    from marketsim.gen._out.order._curried._side_price_floatingprice import side_price_FloatingPrice_IObservableFloatSideFloatIObservableIOrder as _order__curried_side_price_FloatingPrice_IObservableFloatSideFloatIObservableIOrder
    ...
    if floatingPrice is None or rtti.can_be_casted(floatingPrice, IObservablefloat):
        if proto is None or rtti.can_be_casted(proto, IFunctionIFunctionIObservableIOrderIFunctionfloatIFunctionSide):
            return _order__curried_side_price_FloatingPrice_IObservableFloatSideFloatIObservableIOrder(floatingPrice,proto)
