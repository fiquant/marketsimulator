def FloatingPrice(proto = None,floatingPrice = None): 
    ...
    from marketsim.gen._out.order._curried._side_floatingprice import side_FloatingPrice_SideFloatIObservableIOrderIObservableFloat as _order__curried_side_FloatingPrice_SideFloatIObservableIOrderIObservableFloat
