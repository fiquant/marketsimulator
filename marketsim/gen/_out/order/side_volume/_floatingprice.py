def FloatingPrice(floatingPrice = None,proto = None): 
    ...
    from marketsim.gen._out.order._curried._sidevolume_floatingprice import sidevolume_FloatingPrice_IObservableFloatSideFloatFloatIOrderGenerator as _order__curried_sidevolume_FloatingPrice
