def Limit(signedVolume = None,price = None): 
    ...
    from marketsim.gen._out.order._limitsigned import LimitSigned_FloatIFunctionFloat as _order_LimitSigned_FloatIFunctionFloat
    ...
    if signedVolume is None or rtti.can_be_casted(signedVolume, IFunction[float]):
        if price is None or rtti.can_be_casted(price, IFunction[float]):
            return _order_LimitSigned_FloatIFunctionFloat(signedVolume,price)
