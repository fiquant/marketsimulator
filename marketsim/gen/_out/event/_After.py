...
class After(_After_Impl):""" 
    """ 
    def __init__(self, delay = None):from marketsim.gen._out._constant import constant as _constant
    ...
    _properties = {'delay' : IFunction[float]
    }
    def __repr__(self):return "After(%(delay)s)" % self.__dict__
