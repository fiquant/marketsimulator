...
class OnEveryDt(_OnEveryDt_Impl):""" 
    """ 
    def __init__(self, dt = None, x = None):from marketsim.gen._out._constant import constant as _constant
    ...
    _properties = {'dt' : float,
        'x' : IFunction[float]
    }
    def __repr__(self):return "[%(x)s]_dt=%(dt)s" % self.__dict__
