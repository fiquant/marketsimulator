...
class DownMovements_IObservableFloatFloat(Observablefloat):
    ...
    def getImpl(self):
        ...
        return call(_math_Max_FloatIObservableFloat,call(_constant_Float,0.0),call(_ops_Sub_IObservableFloatIObservableFloat,call(_math_Lagged_IObservableFloatFloat,self.source,self.timeframe),self.source))
