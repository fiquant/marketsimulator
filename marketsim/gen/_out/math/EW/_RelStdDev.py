...
class RelStdDev(Observable[float]):""" 
    """ 
    def __init__(self, source = None, alpha = None):from marketsim import float
        from marketsim.ops._all import Observable
    ...
    def __repr__(self):return "RSD_{\\alpha=%(alpha)s}(%(source)s)" % self.__dict__
    
    _internals = ['impl']
    def getImpl(self):from marketsim.gen._out.math.EW._Avg import Avg as _math_EW_Avg
