...
class Max_IObservableFloatIObservableFloat(Observable[float]):
    ...
    def getImpl(self):
        ...
        return _ops_Condition_IFunctionBooleanIObservableFloatIObservableFloat(_ops_Greater_IFunctionFloatIFunctionFloat(self.x,self.y),self.x,self.y)
...
class Max_IFunctionFloatIObservableFloat(Observable[float]):
    ...
    def getImpl(self):
        ...
        from marketsim.gen._out.ops._greater import Greater_IFunctionFloatIFunctionFloat as _ops_Greater_IFunctionFloatIFunctionFloat
        return _ops_Condition_IFunctionBooleanIFunctionFloatIObservableFloat(_ops_Greater_IFunctionFloatIFunctionFloat(self.x,self.y),self.x,self.y)
...
class Max_IObservableFloatIFunctionFloat(Observable[float]):
    ...
    def getImpl(self):
        ...
        from marketsim.gen._out.ops._greater import Greater_IFunctionFloatIFunctionFloat as _ops_Greater_IFunctionFloatIFunctionFloat
        return _ops_Condition_IFunctionBooleanIObservableFloatIFunctionFloat(_ops_Greater_IFunctionFloatIFunctionFloat(self.x,self.y),self.x,self.y)
