...
class Sqr_IFunctionFloat(Observable[float]):
    ...
    def getImpl(self):
        from marketsim.gen._out.ops._mul import Mul_IFunctionFloatIFunctionFloat as _ops_Mul_IFunctionFloatIFunctionFloat
        return _ops_Mul_IFunctionFloatIFunctionFloat(self.x,self.x)
