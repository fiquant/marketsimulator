...
class MinEpsilon(MinEpsilon_Impl):""" 
    ...
    """ 
    def __init__(self, source = None, epsilon = None):from marketsim.gen._out._constant import constant as _constant
        ...
        if isinstance(epsilon, types.IEvent):event.subscribe(self.epsilon, self.fire, self)
    ...
    def __repr__(self):return "Min_{\\epsilon}(%(source)s)" % self.__dict__
