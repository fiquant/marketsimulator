...
class Avg_EW(IDifferentiable):
    ...
    def getImpl(self):
        ...
        return deref_opt(_math_EW_Avg_IObservableFloatFloat(deref_opt(_math_impl_Source_IStatDomain(self.x)),deref_opt(_math_impl_Alpha_EW(self.x))))
...
class Avg_Moving(IDifferentiable):
    ...
    def getImpl(self):
        ...
        return deref_opt(_math_Moving_Avg_IObservableFloatFloat(deref_opt(_math_impl_Source_IStatDomain(self.x)),deref_opt(_math_impl_Timeframe_Moving(self.x))))
