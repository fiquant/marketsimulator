...
class Maximum_Moving(Observablefloat):
    ...
    def getImpl(self):
        ...
        return deref_opt(_math_Moving_Max_IObservableFloatFloat(deref_opt(_Source_Moving(self.x)),deref_opt(_Timeframe_Moving(self.x))))
