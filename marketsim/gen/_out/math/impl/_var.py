...
class Var_IEW(IFunctionfloat):
    ...
    def getImpl(self):
        ...
        return deref_opt(_math_EW_Var_IObservableFloatFloat(deref_opt(_math_impl_Source_IStatDomain(self.x)),deref_opt(_math_impl_Alpha_IEW(self.x))))
...
from marketsim import context
@registry.expose(["Statistics", "Var"])
class Var_ICumulative(IFunctionfloat):
    """ 
    """ 
    def __init__(self, x = None):
...
from marketsim import context
@registry.expose(["Statistics", "Var"])
class Var_IMoving(IFunctionfloat):
    """ 
    """ 
    def __init__(self, x = None):
    ...
    def getImpl(self):
        ...
        return deref_opt(_math_Moving_Var_IObservableFloatFloat(deref_opt(_math_impl_Source_IStatDomain(self.x)),deref_opt(_math_impl_Timeframe_IMoving(self.x))))
...
def Var(x = None): 
    ...
    if x is None or rtti.can_be_casted(x, ICumulative):
        return Var_ICumulative(x)
    if x is None or rtti.can_be_casted(x, IMoving):
        return Var_IMoving(x)
