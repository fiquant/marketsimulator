...
class Var_mathimplIMoving(IFunctionfloat):
    """ 
    """ 
    ...
    def getImpl(self):
        ...
        return deref_opt(_math_Moving_Var_IObservableFloatFloat(deref_opt(_math_impl_Source_mathimplIStatDomain(self.x)),deref_opt(_math_impl_Timeframe_mathimplIMoving(self.x))))
...
from marketsim import context
@registry.expose(["Statistics", "Var"])
class Var_mathimplICumulative(IFunctionfloat):
    """ 
    """ 
    def __init__(self, x = None):
    ...
    def getImpl(self):
        ...
        from marketsim.gen._out.math.impl._source import Source_mathimplIStatDomain as _math_impl_Source_mathimplIStatDomain
        from marketsim import deref_opt
        return deref_opt(_math_Cumulative_Var_IObservableFloat(deref_opt(_math_impl_Source_mathimplIStatDomain(self.x))))
...
from marketsim import context
@registry.expose(["Statistics", "Var"])
class Var_mathimplIEW(IFunctionfloat):
    """ 
    """ 
    def __init__(self, x = None):
    ...
    def getImpl(self):
        ...
        return deref_opt(_math_EW_Var_IObservableFloatFloat(deref_opt(_math_impl_Source_mathimplIStatDomain(self.x)),deref_opt(_math_impl_Alpha_mathimplIEW(self.x))))
