...
class StdDev_EW(IFunctionfloat):
    ...
    def getImpl(self):
        ...
        return deref_opt(_math_EW_StdDev_IObservableFloatFloat(deref_opt(_Source_EW(self.x)),deref_opt(_Alpha_EW(self.x))))
...
class StdDev_Cumulative(IFunctionfloat):
    ...
    def getImpl(self):
        ...
        from marketsim import deref_opt
        return deref_opt(_math_Cumulative_StdDev_IObservableFloat(deref_opt(_Source_Cumulative(self.x))))
...
class StdDev_Moving(IFunctionfloat):
    ...
    def getImpl(self):
        ...
        return deref_opt(_math_Moving_StdDev_IObservableFloatFloat(deref_opt(_Source_Moving(self.x)),deref_opt(_Timeframe_Moving(self.x))))
