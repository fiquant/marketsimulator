...
class expovariate(Function[float]):""" 
    ...
    """ 
    def __init__(self, Lambda = None):from marketsim import rtti
    ...
    _properties = {'Lambda' : float
    }
    def __repr__(self):return "expovariate(%(Lambda)s)" % self.__dict__
    
    def __call__(self, *args, **kwargs):import random
        return random.expovariate(self.Lambda)
    
    def _casts_to(self, dst):return expovariate._types[0]._casts_to(dst)
