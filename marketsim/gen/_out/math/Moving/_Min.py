...
class Min(Min_Impl):""" 
    """ 
    def __init__(self, source = None, timeframe = None):from marketsim.gen._out._constant import constant as _constant
    ...
    def __repr__(self):return "Min_{n=%(timeframe)s}(%(source)s)" % self.__dict__
