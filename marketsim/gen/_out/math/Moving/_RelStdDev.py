...
class RelStdDev(Observable[float]):""" 
    ...
    def __repr__(self):return "RSD_{n=%(timeframe)s}(%(source)s)" % self.__dict__
    
    _internals = ['impl']
    def getImpl(self):from marketsim.gen._out.math.Moving._Avg import Avg as _math_Moving_Avg
