...
class IfDefined(Observable[float]):""" 
    """ 
    def __init__(self, x = None, elsePart = None):from marketsim import float
        from marketsim.ops._all import Observable
    ...
    def __repr__(self):return "If def(%(x)s) else %(elsePart)s" % self.__dict__
    
    _internals = ['impl']
    def getImpl(self):from marketsim.gen._out._null import null as _null
