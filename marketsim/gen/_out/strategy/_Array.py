...
class Array(_Array_Impl):""" 
    """ 
    def __init__(self, strategies = None):from marketsim.gen._out.strategy._Noise import Noise as _strategy_Noise
    ...
    def __repr__(self):return "Array(%(strategies)s)" % self.__dict__
