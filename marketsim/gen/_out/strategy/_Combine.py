...
class Combine(_Combine_Impl):"""   Can be considered as a particular case of Array strategy
    """ 
    def __init__(self, A = None, B = None):from marketsim.gen._out.strategy._Noise import Noise as _strategy_Noise
    ...
    _properties = {'A' : ISingleAssetStrategy,
        'B' : ISingleAssetStrategy
    }
    def __repr__(self):return "Combine(%(A)s, %(B)s)" % self.__dict__
