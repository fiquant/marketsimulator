...
class LiquidityProvider_SideFloatFloatIOrderBook(Observablefloat):
    ...
    def getImpl(self):
        ...
        return call(_ops_Mul_IObservableFloatFloat,call(_orderbook_SafeSidePrice_IOrderQueueFloat,call(_orderbook_Queue_IOrderBookSide,self.book,self.side),call(_constant_Float,self.initialValue)),self.priceDistr)
