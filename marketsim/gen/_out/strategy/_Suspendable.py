...
class Suspendable(_Suspendable_Impl):""" 
    """ 
    def __init__(self, inner = None, predicate = None):from marketsim.gen._out.strategy._Noise import Noise as _strategy_Noise
    ...
    def __repr__(self):return "Suspendable(%(inner)s, %(predicate)s)" % self.__dict__
