...
class Noise(ISingleAssetStrategy):""" 
    """ 
    def __init__(self, eventGen = None, orderFactory = None):from marketsim.gen._out.event._Every import Every as _event_Every
    ...
    def __repr__(self):return "Noise(%(eventGen)s, %(orderFactory)s)" % self.__dict__
    
    _internals = ['impl']
    def getImpl(self):return _strategy_Generic(self.orderFactory(_strategy_side_Noise()),self.eventGen)
