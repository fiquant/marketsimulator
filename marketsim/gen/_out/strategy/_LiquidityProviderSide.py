...
class LiquidityProviderSide_IEventSideFloatIObservableIOrderSideFloatFloat(ISingleAssetStrategy):
    ...
    def getImpl(self):
        ...
        from marketsim import call
        return call(_strategy_Generic_IObservableIOrderIEvent,call(self.orderFactory,self.side,call(_strategy_price_LiquidityProvider_SideFloatFloatIOrderBook,self.side,self.initialValue,self.priceDistr)),self.eventGen)
