...
class Arbitrage(_Arbitrage_Impl):"""  It believes that these assets represent a single asset traded on different venues
    ...
    def __repr__(self):return "Arbitrage" % self.__dict__
