...
class MultiArmedBandit(_MultiarmedBandit2_Impl):"""  In some moments of time the efficiency of the strategies is evaluated
    ...
    """ 
    def __init__(self, strategies = None, account = None, weight = None, normalizer = None, corrector = None):from marketsim.gen._out.strategy._Noise import Noise as _strategy_Noise
    ...
    def __repr__(self):return "MultiArmedBandit(%(strategies)s, %(account)s, %(weight)s, %(normalizer)s, %(corrector)s)" % self.__dict__
