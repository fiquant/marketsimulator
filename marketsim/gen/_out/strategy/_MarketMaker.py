...
class MarketMaker_FloatFloat(ISingleAssetStrategy):
    ...
    def getImpl(self):
        ...
        return _strategy_Combine_ISingleAssetStrategyISingleAssetStrategy(_strategy_Generic_IObservableIOrderIEvent(_order_Iceberg_IObservableIOrderFloat(_order_FloatingPrice_FloatIObservableIOrderIObservableFloat(_order__curried_price_Limit_SideFloat(_side_Sell_(),_constant_Float((self.volume*1000))),_observable_BreaksAtChanges_IObservableFloat(_observable_OnEveryDt_FloatFloat(_ops_Div_IObservableFloatFloat(_orderbook_SafeSidePrice_IOrderQueueFloat(_orderbook_Asks_IOrderBook(),_constant_Float((100+self.delta))),_math_Exp_Float(_ops_Div_FloatFloat(_math_Atan_Float(_trader_Position_IAccount()),_constant_Int(1000)))),0.9))),_constant_Float(self.volume)),_event_After_Float(_constant_Float(0.0))),_strategy_Generic_IObservableIOrderIEvent(_order_Iceberg_IObservableIOrderFloat(_order_FloatingPrice_FloatIObservableIOrderIObservableFloat(_order__curried_price_Limit_SideFloat(_side_Buy_(),_constant_Float((self.volume*1000))),_observable_BreaksAtChanges_IObservableFloat(_observable_OnEveryDt_FloatFloat(_ops_Div_IObservableFloatFloat(_orderbook_SafeSidePrice_IOrderQueueFloat(_orderbook_Bids_IOrderBook(),_constant_Float((100-self.delta))),_math_Exp_Float(_ops_Div_FloatFloat(_math_Atan_Float(_trader_Position_IAccount()),_constant_Int(1000)))),0.9))),_constant_Float(self.volume)),_event_After_Float(_constant_Float(0.0))))
