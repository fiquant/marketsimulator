...
class MarketMaker_FloatFloat(ISingleAssetStrategy):
    ...
    def getImpl(self):
        ...
        return call(_strategy_Combine_ISingleAssetStrategyISingleAssetStrategy,call(_strategy_Generic_IObservableIOrderIEvent,call(_order_Iceberg_IObservableIOrderFloat,call(_order_FloatingPrice_FloatIObservableIOrderIObservableFloat,call(_order__curried_price_Limit_SideFloat,call(_side_Sell_,),call(_constant_Float,(self.volume*1000))),call(_observable_BreaksAtChanges_IObservableFloat,call(_observable_OnEveryDt_FloatFloat,call(_ops_Div_IObservableFloatFloat,call(_orderbook_SafeSidePrice_IOrderQueueFloat,call(_orderbook_Asks_IOrderBook,),call(_constant_Float,(100+self.delta))),call(_math_Exp_Float,call(_ops_Div_FloatFloat,call(_math_Atan_Float,call(_trader_Position_IAccount,)),call(_constant_Int,1000)))),0.9))),call(_constant_Float,self.volume)),call(_event_After_Float,call(_constant_Float,0.0))),call(_strategy_Generic_IObservableIOrderIEvent,call(_order_Iceberg_IObservableIOrderFloat,call(_order_FloatingPrice_FloatIObservableIOrderIObservableFloat,call(_order__curried_price_Limit_SideFloat,call(_side_Buy_,),call(_constant_Float,(self.volume*1000))),call(_observable_BreaksAtChanges_IObservableFloat,call(_observable_OnEveryDt_FloatFloat,call(_ops_Div_IObservableFloatFloat,call(_orderbook_SafeSidePrice_IOrderQueueFloat,call(_orderbook_Bids_IOrderBook,),call(_constant_Float,(100-self.delta))),call(_math_Exp_Float,call(_ops_Div_FloatFloat,call(_math_Atan_Float,call(_trader_Position_IAccount,)),call(_constant_Int,1000)))),0.9))),call(_constant_Float,self.volume)),call(_event_After_Float,call(_constant_Float,0.0))))
