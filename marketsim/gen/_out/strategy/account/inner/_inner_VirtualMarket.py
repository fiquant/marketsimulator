...
class inner_VirtualMarket(IFunction[IAccount, ISingleAssetStrategy]):"""   how it would be traded by sending request.evalMarketOrder
    ...
    def __repr__(self):return "inner_VirtualMarket" % self.__dict__
    
    def __call__(self, inner = None):from marketsim.gen._out.strategy._Noise import Noise as _strategy_Noise
