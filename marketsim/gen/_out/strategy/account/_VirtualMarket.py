...
class VirtualMarket(_VirtualMarket_Impl):"""   how it would be traded by sending request.evalMarketOrder
    ...
    """ 
    def __init__(self, inner = None):from marketsim.gen._out.strategy._Noise import Noise as _strategy_Noise
    ...
    def __repr__(self):return "VirtualMarket(%(inner)s)" % self.__dict__
