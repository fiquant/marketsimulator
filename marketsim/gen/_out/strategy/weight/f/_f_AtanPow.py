...
class f_AtanPow(IFunction[IFunction[float], IFunction[float]]):""" 
    """ 
    def __init__(self, base = None):from marketsim import rtti
    ...
    _properties = {'base' : float
    }
    def __repr__(self):return "f_AtanPow(%(base)s)" % self.__dict__
    
    def __call__(self, f = None):from marketsim.gen._out._constant import constant as _constant
