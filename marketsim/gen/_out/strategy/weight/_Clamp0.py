...
class Clamp0(Function[float]):""" 
    """ 
    def __init__(self, f = None):from marketsim.gen._out._constant import constant as _constant
    ...
    def __repr__(self):return "Clamp0(%(f)s)" % self.__dict__
    
    _internals = ['impl']
    def getImpl(self):return _math_Max(_constant(0),self.f)+1
