...
class array_IdentityL(IFunction[listOf(float), listOf(float)]):""" 
    ...
    def __repr__(self):return "array_IdentityL" % self.__dict__
    
    def __call__(self, array = None):from marketsim.gen._out.strategy.weight._IdentityL import IdentityL
