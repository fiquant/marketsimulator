...
class trader_Score(IFunction[IFunction[float], IAccount]):"""  Returns difference between them.
    ...
    def __repr__(self):return "trader_Score" % self.__dict__
    
    def __call__(self, trader = None):from marketsim.gen._out.trader._SingleProxy import SingleProxy as _trader_SingleProxy
