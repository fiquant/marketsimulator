...
class TrendFollower_FloatFloatIOrderBook(IFunctionSide):
    ...
    def getImpl(self):
        ...
        return deref_opt(_strategy_side_Signal_FloatFloat(deref_opt(_math_Derivative_IDifferentiable(deref_opt(_math_impl_Avg_IEW(deref_opt(_math_impl_EW_IObservableFloatFloat(deref_opt(_orderbook_MidPrice_IOrderBook(self.book)),self.alpha)))))),self.threshold))
