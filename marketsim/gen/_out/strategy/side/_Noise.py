...
class Noise_Float(Function[Side]):
    ...
    def getImpl(self):
        ...
        return _ops_Condition_Side_IFunctionBooleanSideSide(_ops_Greater_IFunctionFloatIFunctionFloat(self.side_distribution,_constant_Float(0.5)),_side_Sell_(),_side_Buy_())
