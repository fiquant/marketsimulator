...
class Signal_IObservableFloatFloat(Observable[Side]):
    ...
    def getImpl(self):
        ...
        return _ops_Condition_IObservableBooleanSideIObservableSide(_ops_Greater_IObservableFloatIFunctionFloat(self.signal,_constant_Float(self.threshold)),_side_Buy_(),_ops_Condition_IObservableBooleanSideSide(_ops_Less_IObservableFloatIFunctionFloat(self.signal,_constant_Float((0-self.threshold))),_side_Sell_(),_side_Nothing_()))
