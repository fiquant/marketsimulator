...
class IFunctionint(Function_impl):
    ...
    def A(self, y = None):
        from marketsim.gen._out._test.in1.in2._a import A
        return A(self,y)
...
class IFunctionR(object):
    ...
    @property
    def A(self):
        from marketsim.gen._out._test.in1._a import A
        return A(self)
