...
class EfficiencyTrend(Function[float]):""" 
    """ 
    def __init__(self, trader = None, alpha = None):from marketsim.gen._out.trader._SingleProxy import SingleProxy as _trader_SingleProxy
    ...
    def __repr__(self):return "EfficiencyTrend(%(trader)s, %(alpha)s)" % self.__dict__
    
    _internals = ['impl']
    def getImpl(self):return _math_Derivative(_math_EW_Avg(_trader_Efficiency(self.trader),self.alpha))
