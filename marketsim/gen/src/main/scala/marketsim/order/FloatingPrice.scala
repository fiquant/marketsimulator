...
{
    case class Order(proto : PriceOrder, floatingPrice : Observable[Option[Ticks]]) extends PriceMetaOrder
    {
        self =>
    ...
    case class Factory(proto : PriceOrderFactory, floatingPrice : Observable[Option[Ticks]]) extends PriceOrderFactory
    {
