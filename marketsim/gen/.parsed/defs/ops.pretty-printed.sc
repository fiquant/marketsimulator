...
package ops {
    ...
    package  {
        ...
        def Mul(x = constant(1.0),
                y = constant(1.0)) : IObservable[Float] // defined at defs\ops.sc: 15.9
        
        @python.intrinsic.observable("ops._Add_Impl")
        @symbol = "+"
        def Add(x = constant(1.0),
                y = constant(1.0)) : IObservable[Float] // defined at defs\ops.sc: 19.9
        
        @python.intrinsic.observable("ops._Sub_Impl")
        @symbol = "-"
        def Sub(x = constant(1.0),
                y = constant(1.0)) : IObservable[Float] // defined at defs\ops.sc: 23.9
    }
    ...
    package  {
        ...
        def Equal(x = constant(1.0),
                  y = constant(1.0)) : IObservable[Boolean] // defined at defs\ops.sc: 43.9
        
        @python.intrinsic.observable("ops._NotEqual_Impl")
        @symbol = "<>"
        def NotEqual(x = constant(1.0),
                     y = constant(1.0)) : IObservable[Boolean] // defined at defs\ops.sc: 47.9
        
        @python.intrinsic.observable("ops._Less_Impl")
        @symbol = "<"
        def Less(x = constant(1.0),
                 y = constant(1.0)) : IObservable[Boolean] // defined at defs\ops.sc: 51.9
        
        @python.intrinsic.observable("ops._LessEqual_Impl")
        @symbol = "<="
        def LessEqual(x = constant(1.0),
                      y = constant(1.0)) : IObservable[Boolean] // defined at defs\ops.sc: 55.9
        
        @python.intrinsic.observable("ops._Greater_Impl")
        @symbol = ">"
        def Greater(x = constant(1.0),
                    y = constant(1.0)) : IObservable[Boolean] // defined at defs\ops.sc: 59.9
        
        @python.intrinsic.observable("ops._GreaterEqual_Impl")
        @symbol = ">="
        def GreaterEqual(x = constant(1.0),
                         y = constant(1.0)) : IObservable[Boolean] // defined at defs\ops.sc: 63.9
    }
}
