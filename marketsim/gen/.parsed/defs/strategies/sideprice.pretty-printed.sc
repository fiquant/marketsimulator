...
package strategy.price() {
    ...
    // defined at defs\strategies\sideprice.sc: 49.5
    ...
    {
        // defined at defs\strategies\sideprice.sc: 74.9
        ...
        // defined at defs\strategies\sideprice.sc: 81.9
    ...
    type MarketMaker(delta = 1.0,volume = 20.0)
    {
        ...
        // defined at defs\strategies\sideprice.sc: 95.9
        def TwoSides() = Combine(OneSide(side.Sell(),1.0),OneSide(side.Buy(),-1.0))
    }
}
