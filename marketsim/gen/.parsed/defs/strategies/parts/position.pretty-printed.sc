...
package strategy.position() {
    ...
    {
        // defined at defs\strategies\parts\position.sc: 6.9
        def Position() = DesiredPosition-trader~>Position-trader~>PendingVolume
        
        // defined at defs\strategies\parts\position.sc: 8.9
    ...
    {
        // defined at defs\strategies\parts\position.sc: 23.9
    ...
    {
        // defined at defs\strategies\parts\position.sc: 39.9
