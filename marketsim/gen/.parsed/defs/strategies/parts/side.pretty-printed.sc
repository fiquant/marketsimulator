...
package strategy.side() {
    ...
    {
        // defined at defs\strategies\parts\side.sc: 14.9
    ...
    {
        // defined at defs\strategies\parts\side.sc: 52.9
    ...
    {
        // defined at defs\strategies\parts\side.sc: 72.9
    ...
    {
        // defined at defs\strategies\parts\side.sc: 90.9
        ...
        // defined at defs\strategies\parts\side.sc: 98.9
        def Side() = FV_Side
    }
    ...
    {
        // defined at defs\strategies\parts\side.sc: 113.9
    ...
    {
        // defined at defs\strategies\parts\side.sc: 137.9
    ...
    type RSIbis(/** parameter |alpha| for exponentially weighted moving average when calculating RSI */ alpha = 1.0/14,/** lag for calculating up and down movements for RSI */ timeframe = 1.0,/** strategy starts to act once RSI is out of [50-threshold, 50+threshold] */ threshold = 30.0) : SideStrategy
    {
        ...
        def Side() = Signal(50.0-orderbook.OfTrader()~>RSI(timeframe,alpha),50.0-threshold)~>S_Side
    }
}
