...
package strategy() {
     ...
     */
    def TradeIfProfitable(/** wrapped strategy */ inner = Empty(),
                          /** defines how strategy trades are booked:
                            ...
                            * if all its orders appeared at market */ account = account.virtualMarket(),
    ...
    def MultiArmedBandit(/** original strategies that can be suspended */ strategies = [Empty()],
                         /** function creating a virtual account used
                           * to estimate efficiency of the strategy itself */ account = account.virtualMarket(),
                         ...
                         /** function that maps trader efficiency to its weight
                           * that will be used for random choice */ normalizer = weight.atanPow(),
    ...
    def ChooseTheBest(/** original strategies that can be suspended */ strategies = [Empty()],
