...
package event {
    // defined at .output\typed.sc: 30.5
    ...
    // defined at .output\typed.sc: 37.5
...
package veusz {
    // defined at .output\typed.sc: 48.5
...
package ops {
    ...
    // defined at .output\typed.sc: 73.5
    @label = "({%(x)s}{{symbol}}{%(y)s})"
    @symbol = "<"
    ...
    // defined at .output\typed.sc: 81.5
    @label = "({%(x)s}{{symbol}}{%(y)s})"
    @symbol = "*"
    ...
    // defined at .output\typed.sc: 89.5
    ...
    // defined at .output\typed.sc: 97.5
    @label = "({%(x)s}{{symbol}}{%(y)s})"
    @symbol = "<>"
    ...
    // defined at .output\typed.sc: 105.5
    @label = "(if %(cond)s then %(ifpart)s else %(elsepart)s)"
    ...
    // defined at .output\typed.sc: 121.5
    @label = "({%(x)s}{{symbol}}{%(y)s})"
    @symbol = "-"
    ...
    // defined at .output\typed.sc: 144.5
    @label = "({%(x)s}{{symbol}}{%(y)s})"
    @symbol = "=="
    ...
    // defined at .output\typed.sc: 152.5
    @label = "({%(x)s}{{symbol}}{%(y)s})"
    @symbol = ">"
...
package math {
    package random {
        // defined at .output\typed.sc: 165.9
        /** Gamma distribution
         *
        ...
        // defined at .output\typed.sc: 181.9
        /** Normal distribution
         */
        @python.random()
        ...
        // defined at .output\typed.sc: 189.9
        /** Pareto distribution
         */
        @python.random()
        ...
        // defined at .output\typed.sc: 211.9
        ...
        // defined at .output\typed.sc: 221.9
        ...
        // defined at .output\typed.sc: 242.9
        ...
        // defined at .output\typed.sc: 251.9
    ...
    package Cumulative {
        // defined at .output\typed.sc: 279.9
        /** Cumulative relative standard deviation
         */
        @label = "RSD{{suffix}}"
        def RelStdDev(/** observable data source */ source : Optional[.IObservable[.Float]] = .const()) : .IObservable[.Float] = (source-.math.Cumulative.Avg(source))/.math.Cumulative.StdDev(source)
        
        // defined at .output\typed.sc: 287.9
        /** Cumulative variance
         */
        ...
        // defined at .output\typed.sc: 295.9
        /** Cumulative average
         */
        @label = "Avg{{suffix}}"
        ...
        // defined at .output\typed.sc: 303.9
        ...
        // defined at .output\typed.sc: 325.9
    ...
    package rsi {
        // defined at .output\typed.sc: 337.9
        ...
        def Raw(/** observable data source */ source : Optional[.IObservable[.Float]] = .const(),
                ...
                /** alpha parameter for EWMA */ alpha : Optional[.Float] = 0.015) : .IFunction[.Float] = .math.EW.Avg(.math.UpMovements(source,timeframe),alpha)/.math.EW.Avg(.math.DownMovements(source,timeframe),alpha)
    }
    @category = "MACD"
    
    package macd {
        // defined at .output\typed.sc: 351.9
        ...
        def MACD(/** source */ x : Optional[.IObservable[.Float]] = .const(),
                 ...
                 /** short period */ fast : Optional[.Float] = 12.0) : .IFunction[.Float] = .math.EW.Avg(x,2.0/(fast+1))-.math.EW.Avg(x,2.0/(slow+1))
        
        // defined at .output\typed.sc: 361.9
        ...
        // defined at .output\typed.sc: 373.9
        ...
        def Histogram(/** source */ x : Optional[.IObservable[.Float]] = .const(),
                      ...
                      /** short period */ fast : Optional[.Float] = 12.0,
                      /** signal period */ timeframe : Optional[.Float] = 9.0,
                      /** discretization step */ step : Optional[.Float] = 1.0) : .IFunction[.Float] = .math.macd.MACD(x,slow,fast)-.math.macd.Signal(x,slow,fast,timeframe,step)
    }
    @category = "Statistics"
    @suffix = "_{\\\\alpha=%(alpha)s}(%(source)s)"
    
    package EW {
        // defined at .output\typed.sc: 390.9
        ...
        // defined at .output\typed.sc: 399.9
        ...
        // defined at .output\typed.sc: 408.9
        ...
        // defined at .output\typed.sc: 417.9
        ...
        def RelStdDev(/** observable data source */ source : Optional[.IObservable[.Float]] = .const(),
                      /** alpha parameter */ alpha : Optional[.Float] = 0.015) : .IObservable[.Float] = (source-.math.EW.Avg(source,alpha))/.math.EW.StdDev(source,alpha)
    }
    @category = "Statistics"
    @suffix = "_{n=%(timeframe)s}(%(source)s)"
    
    package Moving {
        // defined at .output\typed.sc: 431.9
        ...
        // defined at .output\typed.sc: 440.9
        /** Simple moving relative standard deviation
         */
        @label = "RSD{{suffix}}"
        def RelStdDev(/** observable data source */ source : Optional[.IObservable[.Float]] = .const(),
                      /** sliding window size    */ timeframe : Optional[.Float] = 100.0) : .IObservable[.Float] = (source-.math.Moving.Avg(source,timeframe))/.math.Moving.StdDev(source,timeframe)
        
        // defined at .output\typed.sc: 449.9
        /** Simple moving variance
         */
        @label = "\\sigma^2{{suffix}}"
        @python.intrinsic("moments.mv.MV_Impl")
        def Var(/** observable data source */ source : Optional[.IObservable[.Float]] = .const(),
                /** sliding window size    */ timeframe : Optional[.Float] = 100.0) : .IFunction[.Float] = .math.Max(.const(0),.math.Moving.Avg(source*source,timeframe)-.math.Sqr(.math.Moving.Avg(source,timeframe)))
        
        // defined at .output\typed.sc: 459.9
        ...
        // defined at .output\typed.sc: 468.9
        ...
        // defined at .output\typed.sc: 477.9
    ...
    // defined at .output\typed.sc: 487.5
    ...
    def Min(x : Optional[.IFunction[.Float]] = .constant(),
            y : Optional[.IFunction[.Float]] = .constant()) : .IFunction[.Float] = if x<y then x else y
    ...
    def DownMovements(/** observable data source */ source : Optional[.IObservable[.Float]] = .const(),
                      /** lag size */ timeframe : Optional[.Float] = 10.0) : .IObservable[.Float] = .observable.Float(.math.Max(.const(0.0),.math.Lagged(source,timeframe)-source))
    
    // defined at .output\typed.sc: 507.5
    ...
    // defined at .output\typed.sc: 516.5
    ...
    // defined at .output\typed.sc: 525.5
    ...
    // defined at .output\typed.sc: 536.5
    ...
    def UpMovements(/** observable data source */ source : Optional[.IObservable[.Float]] = .const(),
                    /** lag size */ timeframe : Optional[.Float] = 10.0) : .IObservable[.Float] = .observable.Float(.math.Max(.const(0.0),source-.math.Lagged(source,timeframe)))
    
    // defined at .output\typed.sc: 545.5
    /** Square of *x*
     */
    @category = "Log/Pow"
    @label = "{%(x)s}^2"
    @python.observable()
    def Sqr(x : Optional[.IFunction[.Float]] = .constant()) : .IFunction[.Float] = x*x
    
    // defined at .output\typed.sc: 555.5
    /** Log returns
     */
    @label = "LogReturns_{%(timeframe)s}(%(x)s)"
    def LogReturns(/** observable data source */ x : Optional[.IObservable[.Float]] = .const(),
                   /** lag size */ timeframe : Optional[.Float] = 10.0) : () => .Float = .math.Log(x/.math.Lagged(x,timeframe))
    
    // defined at .output\typed.sc: 564.5
    /** Square root of *x*
     *
     */
    @category = "Log/Pow"
    ...
    // defined at .output\typed.sc: 574.5
    /** Relative Strength Index
     */
    @label = "RSI_{%(timeframe)s}^{%(alpha)s}(%(book)s)"
    def RSI(/** asset price in question  */ book : Optional[.IOrderBook] = .orderbook.OfTrader(),
            /** lag size */ timeframe : Optional[.Float] = 10.0,
            /** alpha parameter for EWMA */ alpha : Optional[.Float] = 0.015) : .IObservable[.Float] = .const(100.0)-.const(100.0)/(.const(1.0)+.math.rsi.Raw(.orderbook.MidPrice(book),timeframe,alpha))
    
    // defined at .output\typed.sc: 584.5
    /** Exponent of *x*
     *
     */
    @category = "Log/Pow"
    ...
    // defined at .output\typed.sc: 594.5
    ...
    // defined at .output\typed.sc: 604.5
    ...
    // defined at .output\typed.sc: 615.5
    ...
    // defined at .output\typed.sc: 624.5
...
package order {
    ...
    package _curried {
        // defined at .output\typed.sc: 765.9
        ...
        // defined at .output\typed.sc: 779.9
        ...
        // defined at .output\typed.sc: 802.9
        ...
        // defined at .output\typed.sc: 826.9
        /** Factory creating iceberg orders
         *
         *  Iceberg order is initialized by an underlying order and a lot size.
         *  It sends consequently pieces of the underlying order of size equal or less to the lot size
        ...
        // defined at .output\typed.sc: 838.9
        ...
        // defined at .output\typed.sc: 850.9
        /** Factory creating StopLoss orders
         *
         *  StopLoss order is initialised by an underlying order and a maximal acceptable loss factor.
         *  It keeps track of position and balance change induced by trades of the underlying order and
        ...
        // defined at .output\typed.sc: 863.9
        /** Factory creating Immediate-Or-Cancel orders
         *
         *  Immediate-Or-Cancel order sends an underlying order to the market and
         *  immediately sends a cancel request for it.
        ...
        // defined at .output\typed.sc: 877.9
        /** Factory creating WithExpiry orders
         *
         * WithExpiry orders can be viewed as ImmediateOrCancel orders
         * where cancel order is sent not immediately but after some delay
        ...
        // defined at .output\typed.sc: 888.9
        /** Factory creating StopLoss orders
         *
         *  StopLoss order is initialised by an underlying order and a maximal acceptable loss factor.
         *  It keeps track of position and balance change induced by trades of the underlying order and
        ...
        // defined at .output\typed.sc: 901.9
        ...
        // defined at .output\typed.sc: 913.9
        /** Factory creating iceberg orders
         *
         *  Iceberg order is initialized by an underlying order and a lot size.
         *  It sends consequently pieces of the underlying order of size equal or less to the lot size
        ...
        // defined at .output\typed.sc: 925.9
        /** Factory creating WithExpiry orders
         *
         * WithExpiry orders can be viewed as ImmediateOrCancel orders
         * where cancel order is sent not immediately but after some delay
        ...
        // defined at .output\typed.sc: 936.9
        /** Factory creating Peg orders
         *
         *  A peg order is a particular case of the floating price order
         *  with the price better at one tick than the best price of the order queue.
        ...
        // defined at .output\typed.sc: 948.9
        /** Factory creating Immediate-Or-Cancel orders
         *
         *  Immediate-Or-Cancel order sends an underlying order to the market and
         *  immediately sends a cancel request for it.
        ...
        // defined at .output\typed.sc: 962.9
        ...
        // defined at .output\typed.sc: 976.9
        /** Factory creating limit orders
         *
         *  Limit orders ask to buy or sell some asset at price better than some limit price.
         *  If a limit order is not competely fulfilled
        ...
        // defined at .output\typed.sc: 987.9
        /** Factory creating Peg orders
         *
         *  A peg order is a particular case of the floating price order
         *  with the price better at one tick than the best price of the order queue.
        ...
        // defined at .output\typed.sc: 999.9
        /** Factory creating Peg orders
         *
         *  A peg order is a particular case of the floating price order
         *  with the price better at one tick than the best price of the order queue.
        ...
        // defined at .output\typed.sc: 1011.9
        /** Factory creating Peg orders
         *
         *  A peg order is a particular case of the floating price order
         *  with the price better at one tick than the best price of the order queue.
        ...
        // defined at .output\typed.sc: 1023.9
        /** Factory creating limit orders
         *
         *  Limit orders ask to buy or sell some asset at price better than some limit price.
         *  If a limit order is not competely fulfilled
        ...
        // defined at .output\typed.sc: 1034.9
        /** Factory creating iceberg orders
         *
         *  Iceberg order is initialized by an underlying order and a lot size.
         *  It sends consequently pieces of the underlying order of size equal or less to the lot size
        ...
        // defined at .output\typed.sc: 1046.9
        /** Factory creating Immediate-Or-Cancel orders
         *
         *  Immediate-Or-Cancel order sends an underlying order to the market and
         *  immediately sends a cancel request for it.
        ...
        // defined at .output\typed.sc: 1071.9
        /** Factory creating StopLoss orders
         *
         *  StopLoss order is initialised by an underlying order and a maximal acceptable loss factor.
         *  It keeps track of position and balance change induced by trades of the underlying order and
        ...
        // defined at .output\typed.sc: 1084.9
        /** Factory creating StopLoss orders
         *
         *  StopLoss order is initialised by an underlying order and a maximal acceptable loss factor.
         *  It keeps track of position and balance change induced by trades of the underlying order and
        ...
        // defined at .output\typed.sc: 1109.9
        /** Factory creating StopLoss orders
         *
         *  StopLoss order is initialised by an underlying order and a maximal acceptable loss factor.
         *  It keeps track of position and balance change induced by trades of the underlying order and
        ...
        // defined at .output\typed.sc: 1122.9
        /** Factory creating limit orders
         *
         *  Limit orders ask to buy or sell some asset at price better than some limit price.
         *  If a limit order is not competely fulfilled
        ...
        // defined at .output\typed.sc: 1133.9
        /** Factory creating StopLoss orders
         *
         *  StopLoss order is initialised by an underlying order and a maximal acceptable loss factor.
         *  It keeps track of position and balance change induced by trades of the underlying order and
        ...
        // defined at .output\typed.sc: 1146.9
        /** Factory creating WithExpiry orders
         *
         * WithExpiry orders can be viewed as ImmediateOrCancel orders
         * where cancel order is sent not immediately but after some delay
        ...
        // defined at .output\typed.sc: 1157.9
        /** Factory creating WithExpiry orders
         *
         * WithExpiry orders can be viewed as ImmediateOrCancel orders
         * where cancel order is sent not immediately but after some delay
        ...
        // defined at .output\typed.sc: 1168.9
        /** Factory creating Immediate-Or-Cancel orders
         *
         *  Immediate-Or-Cancel order sends an underlying order to the market and
         *  immediately sends a cancel request for it.
        ...
        // defined at .output\typed.sc: 1182.9
        /** Factory creating orders with floating price
         *
         *  Floating price order is initialized by an order having a price and an observable that generates new prices.
         *  When the observable value changes the order is cancelled and
        ...
        // defined at .output\typed.sc: 1194.9
        ...
        // defined at .output\typed.sc: 1203.9
        /** Factory creating StopLoss orders
         *
         *  StopLoss order is initialised by an underlying order and a maximal acceptable loss factor.
         *  It keeps track of position and balance change induced by trades of the underlying order and
        ...
        // defined at .output\typed.sc: 1216.9
        /** Factory creating Immediate-Or-Cancel orders
         *
         *  Immediate-Or-Cancel order sends an underlying order to the market and
         *  immediately sends a cancel request for it.
        ...
        // defined at .output\typed.sc: 1230.9
        /** Factory creating limit orders
         *
         *  Limit orders ask to buy or sell some asset at price better than some limit price.
         *  If a limit order is not competely fulfilled
        ...
        // defined at .output\typed.sc: 1266.9
        /** Factory creating WithExpiry orders
         *
         * WithExpiry orders can be viewed as ImmediateOrCancel orders
         * where cancel order is sent not immediately but after some delay
        ...
        // defined at .output\typed.sc: 1288.9
        /** Factory creating iceberg orders
         *
         *  Iceberg order is initialized by an underlying order and a lot size.
         *  It sends consequently pieces of the underlying order of size equal or less to the lot size
        ...
        // defined at .output\typed.sc: 1300.9
        /** Factory creating orders with floating price
         *
         *  Floating price order is initialized by an order having a price and an observable that generates new prices.
         *  When the observable value changes the order is cancelled and
        ...
        // defined at .output\typed.sc: 1321.9
        /** Factory creating orders with floating price
         *
         *  Floating price order is initialized by an order having a price and an observable that generates new prices.
         *  When the observable value changes the order is cancelled and
        ...
        // defined at .output\typed.sc: 1333.9
        /** Factory creating orders with floating price
         *
         *  Floating price order is initialized by an order having a price and an observable that generates new prices.
         *  When the observable value changes the order is cancelled and
        ...
        // defined at .output\typed.sc: 1345.9
        /** Factory creating WithExpiry orders
         *
         * WithExpiry orders can be viewed as ImmediateOrCancel orders
         * where cancel order is sent not immediately but after some delay
        ...
        // defined at .output\typed.sc: 1356.9
        /** Factory creating iceberg orders
         *
         *  Iceberg order is initialized by an underlying order and a lot size.
         *  It sends consequently pieces of the underlying order of size equal or less to the lot size
        ...
        // defined at .output\typed.sc: 1380.9
        /** Factory creating Immediate-Or-Cancel orders
         *
         *  Immediate-Or-Cancel order sends an underlying order to the market and
         *  immediately sends a cancel request for it.
        ...
        // defined at .output\typed.sc: 1394.9
        /** Factory creating market orders
         *
         *  Market order intructs buy or sell given volume immediately
         */
        ...
        // defined at .output\typed.sc: 1403.9
        /** Factory creating limit orders
         *
         *  Limit orders ask to buy or sell some asset at price better than some limit price.
         *  If a limit order is not competely fulfilled
        ...
        // defined at .output\typed.sc: 1415.9
        /** Factory creating limit orders
         *
         *  Limit orders ask to buy or sell some asset at price better than some limit price.
         *  If a limit order is not competely fulfilled
        ...
        // defined at .output\typed.sc: 1426.9
        /** Factory creating iceberg orders
         *
         *  Iceberg order is initialized by an underlying order and a lot size.
         *  It sends consequently pieces of the underlying order of size equal or less to the lot size
        ...
        // defined at .output\typed.sc: 1438.9
        /** Factory creating Peg orders
         *
         *  A peg order is a particular case of the floating price order
         *  with the price better at one tick than the best price of the order queue.
        ...
        // defined at .output\typed.sc: 1450.9
        /** Factory creating market orders
         *
         *  Market order intructs buy or sell given volume immediately
         */
        ...
        // defined at .output\typed.sc: 1459.9
        /** Factory creating Immediate-Or-Cancel orders
         *
         *  Immediate-Or-Cancel order sends an underlying order to the market and
         *  immediately sends a cancel request for it.
        ...
        // defined at .output\typed.sc: 1473.9
        /** Factory creating Peg orders
         *
         *  A peg order is a particular case of the floating price order
         *  with the price better at one tick than the best price of the order queue.
        ...
        // defined at .output\typed.sc: 1485.9
        /** Factory creating iceberg orders
         *
         *  Iceberg order is initialized by an underlying order and a lot size.
         *  It sends consequently pieces of the underlying order of size equal or less to the lot size
        ...
        // defined at .output\typed.sc: 1497.9
        /** Factory creating limit orders
         *
         *  Limit orders ask to buy or sell some asset at price better than some limit price.
         *  If a limit order is not competely fulfilled
    ...
    // defined at .output\typed.sc: 1545.5
    /** Factory creating limit orders
     *
     *  Limit orders ask to buy or sell some asset at price better than some limit price.
     *  If a limit order is not competely fulfilled
    ...
    // defined at .output\typed.sc: 1558.5
    /** Factory creating market orders
     *
     *  Market order intructs buy or sell given volume immediately
     */
    ...
    // defined at .output\typed.sc: 1567.5
    /** Factory creating Immediate-Or-Cancel orders
     *
     *  Immediate-Or-Cancel order sends an underlying order to the market and
     *  immediately sends a cancel request for it.
    ...
    // defined at .output\typed.sc: 1581.5
    /** Factory creating market orders
     *
     *  Market order intructs buy or sell given volume immediately
     */
    ...
    // defined at .output\typed.sc: 1591.5
    /** Factory creating StopLoss orders
     *
     *  StopLoss order is initialised by an underlying order and a maximal acceptable loss factor.
     *  It keeps track of position and balance change induced by trades of the underlying order and
    ...
    // defined at .output\typed.sc: 1604.5
    /** Factory creating WithExpiry orders
     *
     * WithExpiry orders can be viewed as ImmediateOrCancel orders
     * where cancel order is sent not immediately but after some delay
    ...
    // defined at .output\typed.sc: 1615.5
    /** Factory creating orders with floating price
     *
     *  Floating price order is initialized by an order having a price and an observable that generates new prices.
     *  When the observable value changes the order is cancelled and
    ...
    // defined at .output\typed.sc: 1627.5
    /** Factory creating iceberg orders
     *
     *  Iceberg order is initialized by an underlying order and a lot size.
     *  It sends consequently pieces of the underlying order of size equal or less to the lot size
    ...
    // defined at .output\typed.sc: 1639.5
    /** Factory creating fixed budget orders
     *
     *  Fixed budget order acts like a market order
     *  but the volume is implicitly given by a budget available for trades.
    ...
    // defined at .output\typed.sc: 1654.5
    /** Factory creating limit orders
     *
     *  Limit orders ask to buy or sell some asset at price better than some limit price.
     *  If a limit order is not competely fulfilled
    ...
    // defined at .output\typed.sc: 1666.5
    /** Factory creating Peg orders
     *
     *  A peg order is a particular case of the floating price order
     *  with the price better at one tick than the best price of the order queue.
...
package strategy {@category = "Side function"
    ...
    package side {
        // defined at .output\typed.sc: 1684.9
        ...
        def PairTrading(/** reference to order book for another asset used to evaluate fair price of our asset */ bookToDependOn : Optional[.IOrderBook] = .orderbook.OfTrader(),
                        ...
                        /** asset in question */ book : Optional[.IOrderBook] = .orderbook.OfTrader()) : .IObservable[.Side] = .observable.Side(.strategy.side.FundamentalValue(.orderbook.MidPrice(bookToDependOn)*.const(factor),book))
        ...
        def Signal(/** signal to be listened to */ signal : Optional[.IFunction[.Float]] = .constant(0.0),
                   /** threshold when the trader starts to act */ threshold : Optional[.Float] = 0.7) : () => .Side = if signal>.const(threshold) then .side.Buy() else if signal<.const(0-threshold) then .side.Sell() else .side.Nothing()
        
        // defined at .output\typed.sc: 1702.9
        ...
        def CrossingAverages(/** parameter |alpha| for exponentially weighted moving average 1 */ alpha_1 : Optional[.Float] = 0.15,
                             ...
                             /** asset in question */ book : Optional[.IOrderBook] = .orderbook.OfTrader()) : () => .Side = .strategy.side.Signal(.math.EW.Avg(.orderbook.MidPrice(book),alpha_1)-.math.EW.Avg(.orderbook.MidPrice(book),alpha_2),threshold)
        
        // defined at .output\typed.sc: 1712.9
        ...
        def TrendFollower(/** parameter |alpha| for exponentially weighted moving average */ alpha : Optional[.Float] = 0.15,
                          /** threshold when the trader starts to act */ threshold : Optional[.Float] = 0.0,
                          /** asset in question */ book : Optional[.IOrderBook] = .orderbook.OfTrader()) : () => .Side = .strategy.side.Signal(.math.Derivative(.math.EW.Avg(.orderbook.MidPrice(book),alpha)),threshold)
        
        // defined at .output\typed.sc: 1721.9
        ...
        def FundamentalValue(/** observable fundamental value */ fv : Optional[.IFunction[.Float]] = .constant(200.0),
                             /** asset in question */ book : Optional[.IOrderBook] = .orderbook.OfTrader()) : () => .Side = if .orderbook.bid.Price(book)>fv then .side.Sell() else if .orderbook.ask.Price(book)<fv then .side.Buy() else .side.Nothing()
        ...
        def MeanReversion(/** parameter |alpha| for exponentially weighted moving average */ alpha : Optional[.Float] = 0.015,
                          /** asset in question */ book : Optional[.IOrderBook] = .orderbook.OfTrader()) : () => .Side = .strategy.side.FundamentalValue(.math.EW.Avg(.orderbook.MidPrice(book),alpha),book)
        
        // defined at .output\typed.sc: 1738.9
        /** Side function for a noise trading strategy
         */
        def Noise(side_distribution : Optional[() => .Float] = .math.random.uniform(0.0,1.0)) : () => .Side = if side_distribution>.const(0.5) then .side.Sell() else .side.Buy()
    }
    
    package weight {
        package array {
            // defined at .output\typed.sc: 1749.13
            /** Identity function for an array of floats
             */
            @python.curried("IdentityL")
            def array_IdentityL() : Optional[List[.Float]] => List[.Float]
            
            // defined at .output\typed.sc: 1756.13
        ...
        package trader {
            // defined at .output\typed.sc: 1767.13
            ...
            // defined at .output\typed.sc: 1774.13
            ...
            // defined at .output\typed.sc: 1781.13
            ...
            // defined at .output\typed.sc: 1791.13
        ...
        package f {
            // defined at .output\typed.sc: 1801.13
        ...
        // defined at .output\typed.sc: 1823.9
        /** Function returning an array of length *len(array)*
         *  having 1 at the index of the maximal element and 0 are at the rest
         */
        ...
        // defined at .output\typed.sc: 1885.9
        /** Identity function for an array of floats
         */
        ...
        // defined at .output\typed.sc: 1893.9
        /** identity scaling = f(x)
         */
        @curried("f")
    ...
    package price {
        // defined at .output\typed.sc: 1920.9
        ...
        def LiquidityProvider(/** side of orders to create */ side : Optional[() => .Side] = .side.Sell(),
                              ...
                              /** asset in question */ book : Optional[.IOrderBook] = .orderbook.OfTrader()) : .IObservable[.Float] = .orderbook.SafeSidePrice(.orderbook.Queue(book,side),.constant(initialValue))*priceDistr
    }
    @category = "Volume function"
    
    package position {
        // defined at .output\typed.sc: 1935.9
        ...
        def DesiredPosition(/** observable desired position */ desiredPosition : Optional[.IObservable[.Float]] = .const(),
                            /** trader in question */ trader : Optional[.ISingleAssetTrader] = .trader.SingleProxy()) : .IObservable[.Volume] = .observable.Volume(desiredPosition-.trader.Position(trader)-.trader.PendingVolume(trader))
        ...
        def RSI_linear(/** alpha parameter for exponentially moving averages of up movements and down movements */ alpha : Optional[.Float] = 1.0/14.0,
                       ...
                       /** trader in question */ trader : Optional[.ISingleAssetTrader] = .trader.SingleProxy()) : .IObservable[.Volume] = .strategy.position.DesiredPosition(.observable.OnEveryDt(1.0,.const(50.0)-.math.RSI(.orderbook.OfTrader(trader),timeframe,alpha))*k,trader)
        
        // defined at .output\typed.sc: 1953.9
        ...
        def Bollinger_linear(/** alpha parameter for exponentially weighted moving everage and variance */ alpha : Optional[.Float] = 0.15,
                             ...
                             /** trader in question */ trader : Optional[.ISingleAssetTrader] = .trader.SingleProxy()) : .IObservable[.Volume] = .strategy.position.DesiredPosition(.observable.OnEveryDt(1.0,.math.EW.RelStdDev(.orderbook.MidPrice(.orderbook.OfTrader(trader)),alpha))*k,trader)
    }
    
    package account {
        package inner {
            // defined at .output\typed.sc: 1966.13
            ...
            // defined at .output\typed.sc: 1976.13
        ...
        // defined at .output\typed.sc: 1985.9
        /** Associated with a strategy account that tracks
         *  how orders sent by the strategy have been actually traded
         */
        ...
        // defined at .output\typed.sc: 1994.9
        /** Associated with a strategy account that evaluates for every order sent by the strategy
         *  how it would be traded by sending request.evalMarketOrder
         *  (note: orders sent by a strategy wrapped into an adaptive strategy may not come to the market
         *  but we want evaluate in any case would it be profitable or not)
    ...
    // defined at .output\typed.sc: 2009.5
    ...
    // defined at .output\typed.sc: 2018.5
    ...
    // defined at .output\typed.sc: 2028.5
    ...
    // defined at .output\typed.sc: 2043.5
    ...
    // defined at .output\typed.sc: 2056.5
    ...
    // defined at .output\typed.sc: 2068.5
    ...
    // defined at .output\typed.sc: 2079.5
    ...
    // defined at .output\typed.sc: 2093.5
    ...
    // defined at .output\typed.sc: 2101.5
    ...
    // defined at .output\typed.sc: 2116.5
    ...
    // defined at .output\typed.sc: 2127.5
    ...
    // defined at .output\typed.sc: 2137.5
    ...
    def RSIbis(/** Event source making the strategy to wake up*/ eventGen : Optional[.IEvent] = .event.Every(.math.random.expovariate(1.0)),
               ...
               /** strategy starts to act once RSI is out of [50-threshold, 50+threshold] */ threshold : Optional[.Float] = 30.0) : .ISingleAssetStrategy = .strategy.Generic(orderFactory(.strategy.side.Signal(.const(50.0)-.math.RSI(.orderbook.OfTrader(),timeframe,alpha),50.0-threshold)),eventGen)
    
    // defined at .output\typed.sc: 2150.5
    ...
    def TradeIfProfitable(/** wrapped strategy */ inner : Optional[.ISingleAssetStrategy] = .strategy.Noise(),
                          ...
                          /** given a trading account tells should it be considered as effective or not */ performance : Optional[.IAccount => .IFunction[.Float]] = .strategy.weight.trader.trader_EfficiencyTrend()) : .ISingleAssetStrategy = .strategy.Suspendable(inner,performance(account(inner))>=0)
    
    // defined at .output\typed.sc: 2160.5
    ...
    // defined at .output\typed.sc: 2167.5
    ...
    // defined at .output\typed.sc: 2203.5
    ...
    // defined at .output\typed.sc: 2220.5
    ...
    // defined at .output\typed.sc: 2229.5
    ...
    // defined at .output\typed.sc: 2241.5
    ...
    // defined at .output\typed.sc: 2251.5
    ...
    // defined at .output\typed.sc: 2264.5
...
package trader {
    // defined at .output\typed.sc: 2277.5
    ...
    // defined at .output\typed.sc: 2284.5
    /** Returns traders naive approximation of trader eficiency.
     *  It takes into account only the best price of the order queue
     */
    def RoughPnL(trader : Optional[.IAccount] = .trader.SingleProxy() : .IAccount) : .IObservable[.Float] = .observable.Float(.trader.Balance(trader)+.orderbook.NaiveCumulativePrice(.orderbook.OfTrader(trader),.trader.Position(trader)))
    
    // defined at .output\typed.sc: 2292.5
    ...
    // defined at .output\typed.sc: 2301.5
    /** Returns traders eficiency. Under efficiency we understand trader balance if trader position was cleared
     */
    def Efficiency(trader : Optional[.IAccount] = .trader.SingleProxy() : .IAccount) : .IObservable[.Float] = .observable.Float(.trader.Balance(trader)+.orderbook.CumulativePrice(.orderbook.OfTrader(trader),.trader.Position(trader)))
    
    // defined at .output\typed.sc: 2308.5
    ...
    // defined at .output\typed.sc: 2317.5
    ...
    // defined at .output\typed.sc: 2331.5
    /** Returns first derivative of a moving average of the trader efficiency
     */
...
package orderbook {@queue = "Ask_{%(book)s}"
    ...
    package ask {
        // defined at .output\typed.sc: 2365.9
        ...
        // defined at .output\typed.sc: 2372.9
    ...
    // defined at .output\typed.sc: 2434.5
    ...
    // defined at .output\typed.sc: 2454.5
    ...
    def WeightedPrice(queue : Optional[.IOrderQueue] = .orderbook.Asks(),
                      /** parameter alpha for the moving average  */ alpha : Optional[.Float] = 0.15) : .IFunction[.Float] = .math.EW.Avg(.orderbook.LastTradePrice(queue)*.orderbook.LastTradeVolume(queue),alpha)/.math.EW.Avg(.orderbook.LastTradeVolume(queue),alpha)
    
    // defined at .output\typed.sc: 2463.5
    ...
    // defined at .output\typed.sc: 2470.5
    /** MidPrice of order *book*
     */
    def MidPrice(book : Optional[.IOrderBook] = .orderbook.OfTrader()) : .IObservable[.Price] = .observable.Price((.orderbook.ask.Price(book)+.orderbook.bid.Price(book))/.const(2.0))
    ...
    // defined at .output\typed.sc: 2485.5
    ...
    // defined at .output\typed.sc: 2509.5
    ...
    // defined at .output\typed.sc: 2520.5
    ...
    // defined at .output\typed.sc: 2528.5
    ...
    // defined at .output\typed.sc: 2538.5
    ...
    // defined at .output\typed.sc: 2552.5
    ...
    // defined at .output\typed.sc: 2563.5
    ...
    // defined at .output\typed.sc: 2583.5
    ...
    // defined at .output\typed.sc: 2594.5
    ...
    def NaiveCumulativePrice(book : Optional[.IOrderBook] = .orderbook.OfTrader(),
                             depth : Optional[.IFunction[.Float]] = .constant()) : .IObservable[.Price] = .observable.Price(if depth<.const(0.0) then depth*.orderbook.ask.Price(book) else if depth>.const(0.0) then depth*.orderbook.bid.Price(book) else .const(0.0))
    
    // defined at .output\typed.sc: 2606.5
    ...
    // defined at .output\typed.sc: 2616.5
    /** Spread of order *book*
     */
    def Spread(book : Optional[.IOrderBook] = .orderbook.OfTrader()) : .IObservable[.Price] = .observable.Price(.orderbook.ask.Price(book)-.orderbook.bid.Price(book))
    
    // defined at .output\typed.sc: 2623.5
...
package observable {
    // defined at .output\typed.sc: 2635.5
    ...
    // defined at .output\typed.sc: 2645.5
    ...
    // defined at .output\typed.sc: 2654.5
    ...
    // defined at .output\typed.sc: 2663.5
    ...
    // defined at .output\typed.sc: 2672.5
    ...
    // defined at .output\typed.sc: 2680.5
    ...
    // defined at .output\typed.sc: 2689.5
...
// defined at .output\typed.sc: 2799.1
...
// defined at .output\typed.sc: 2808.1
...
// defined at .output\typed.sc: 2817.1
...
// defined at .output\typed.sc: 2825.1
...
// defined at .output\typed.sc: 2838.1
...
// defined at .output\typed.sc: 2847.1
...
// defined at .output\typed.sc: 2858.1
...
// defined at .output\typed.sc: 2867.1
...
def IfDefined(x : Optional[.IFunction[.Float]] = .constant(),
              /** function to take values from when *x* is undefined */ elsePart : Optional[.IFunction[.Float]] = .constant()) : .IFunction[.Float] = if x<>.null() then x else elsePart

// defined at .output\typed.sc: 2878.1
