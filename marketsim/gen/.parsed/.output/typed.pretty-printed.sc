...
package ops {
    ...
    // defined at .output\typed.sc: 125.5
    @label = "({%(x)s}{{symbol}}{%(y)s})"
    @symbol = "<="
    ...
    // defined at .output\typed.sc: 132.5
    @label = "({%(x)s}{{symbol}}{%(y)s})"
    @symbol = "=="
    ...
    // defined at .output\typed.sc: 139.5
    @label = "({%(x)s}{{symbol}}{%(y)s})"
    @symbol = ">"
...
package math {
    package random {
        // defined at .output\typed.sc: 151.9
        /** Gamma distribution
         *
        ...
        // defined at .output\typed.sc: 166.9
        /** Normal distribution
         */
        @python.random()
        ...
        // defined at .output\typed.sc: 179.9
        ...
        // defined at .output\typed.sc: 193.9
        ...
        // defined at .output\typed.sc: 202.9
        ...
        // defined at .output\typed.sc: 214.9
        ...
        // defined at .output\typed.sc: 229.9
        ...
        // defined at .output\typed.sc: 240.9
        /** Beta distribution
         *
         * Conditions on the parameters are |alpha| > 0 and |beta| > 0.
    ...
    package Cumulative {
        // defined at .output\typed.sc: 255.9
        ...
        // defined at .output\typed.sc: 262.9
        /** Cumulative variance
         */
        ...
        // defined at .output\typed.sc: 269.9
        /** Cumulative average
         */
        @label = "Avg{{suffix}}"
        ...
        // defined at .output\typed.sc: 276.9
        ...
        // defined at .output\typed.sc: 286.9
        ...
        // defined at .output\typed.sc: 296.9
    ...
    package rsi {
        // defined at .output\typed.sc: 307.9
    ...
    package macd {
        // defined at .output\typed.sc: 320.9
        ...
        // defined at .output\typed.sc: 329.9
        ...
        // defined at .output\typed.sc: 340.9
    ...
    package EW {
        // defined at .output\typed.sc: 356.9
        ...
        // defined at .output\typed.sc: 364.9
        ...
        // defined at .output\typed.sc: 372.9
        ...
        // defined at .output\typed.sc: 380.9
    ...
    package Moving {
        // defined at .output\typed.sc: 393.9
        ...
        // defined at .output\typed.sc: 401.9
        ...
        // defined at .output\typed.sc: 409.9
        ...
        // defined at .output\typed.sc: 418.9
        ...
        // defined at .output\typed.sc: 426.9
        ...
        // defined at .output\typed.sc: 434.9
    ...
    // defined at .output\typed.sc: 443.5
    ...
    // defined at .output\typed.sc: 453.5
    ...
    def DownMovements(/** observable data source */ source : Optional[.IObservable[.Float]] = .const(),
                      /** lag size */ timeframe : Optional[.Float] = 10.0) : .IObservable[.Float] = .observable.Float(.math.Max(.constant(0.0),.ops.Sub(.math.Lagged(source,timeframe),source)))
    ...
    // defined at .output\typed.sc: 469.5
    ...
    // defined at .output\typed.sc: 477.5
    ...
    def UpMovements(/** observable data source */ source : Optional[.IObservable[.Float]] = .const(),
                    /** lag size */ timeframe : Optional[.Float] = 10.0) : .IObservable[.Float] = .observable.Float(.math.Max(.constant(0.0),.ops.Sub(source,.math.Lagged(source,timeframe))))
    
    // defined at .output\typed.sc: 495.5
    /** Square of *x*
     */
    @category = "Log/Pow"
    @label = "{%(x)s}^2"
    ...
    // defined at .output\typed.sc: 504.5
    /** Log returns
     */
    ...
    // defined at .output\typed.sc: 512.5
    /** Square root of *x*
     *
     */
    @category = "Log/Pow"
    ...
    // defined at .output\typed.sc: 521.5
    ...
    // defined at .output\typed.sc: 530.5
    /** Exponent of *x*
     *
     */
    @category = "Log/Pow"
    ...
    // defined at .output\typed.sc: 539.5
    ...
    // defined at .output\typed.sc: 548.5
    ...
    // defined at .output\typed.sc: 558.5
    ...
    // defined at .output\typed.sc: 566.5
...
package order {
    ...
    package _curried {
        // defined at .output\typed.sc: 706.9
        ...
        // defined at .output\typed.sc: 719.9
        ...
        // defined at .output\typed.sc: 729.9
        ...
        // defined at .output\typed.sc: 750.9
        ...
        // defined at .output\typed.sc: 762.9
        /** Factory creating iceberg orders
         *
         *  Iceberg order is initialized by an underlying order and a lot size.
         *  It sends consequently pieces of the underlying order of size equal or less to the lot size
        ...
        // defined at .output\typed.sc: 773.9
        ...
        // defined at .output\typed.sc: 784.9
        /** Factory creating StopLoss orders
         *
         *  StopLoss order is initialised by an underlying order and a maximal acceptable loss factor.
         *  It keeps track of position and balance change induced by trades of the underlying order and
        ...
        // defined at .output\typed.sc: 796.9
        /** Factory creating Immediate-Or-Cancel orders
         *
         *  Immediate-Or-Cancel order sends an underlying order to the market and
         *  immediately sends a cancel request for it.
        ...
        // defined at .output\typed.sc: 809.9
        /** Factory creating WithExpiry orders
         *
         * WithExpiry orders can be viewed as ImmediateOrCancel orders
         * where cancel order is sent not immediately but after some delay
        ...
        // defined at .output\typed.sc: 819.9
        /** Factory creating StopLoss orders
         *
         *  StopLoss order is initialised by an underlying order and a maximal acceptable loss factor.
         *  It keeps track of position and balance change induced by trades of the underlying order and
        ...
        // defined at .output\typed.sc: 831.9
        ...
        // defined at .output\typed.sc: 842.9
        /** Factory creating iceberg orders
         *
         *  Iceberg order is initialized by an underlying order and a lot size.
         *  It sends consequently pieces of the underlying order of size equal or less to the lot size
        ...
        // defined at .output\typed.sc: 853.9
        /** Factory creating WithExpiry orders
         *
         * WithExpiry orders can be viewed as ImmediateOrCancel orders
         * where cancel order is sent not immediately but after some delay
        ...
        // defined at .output\typed.sc: 874.9
        /** Factory creating Immediate-Or-Cancel orders
         *
         *  Immediate-Or-Cancel order sends an underlying order to the market and
         *  immediately sends a cancel request for it.
        ...
        // defined at .output\typed.sc: 887.9
        ...
        // defined at .output\typed.sc: 900.9
        /** Factory creating limit orders
         *
         *  Limit orders ask to buy or sell some asset at price better than some limit price.
         *  If a limit order is not competely fulfilled
        ...
        // defined at .output\typed.sc: 910.9
        /** Factory creating Peg orders
         *
         *  A peg order is a particular case of the floating price order
         *  with the price better at one tick than the best price of the order queue.
        ...
        // defined at .output\typed.sc: 921.9
        /** Factory creating Peg orders
         *
         *  A peg order is a particular case of the floating price order
         *  with the price better at one tick than the best price of the order queue.
        ...
        // defined at .output\typed.sc: 932.9
        /** Factory creating Peg orders
         *
         *  A peg order is a particular case of the floating price order
         *  with the price better at one tick than the best price of the order queue.
        ...
        // defined at .output\typed.sc: 943.9
        /** Factory creating limit orders
         *
         *  Limit orders ask to buy or sell some asset at price better than some limit price.
         *  If a limit order is not competely fulfilled
        ...
        // defined at .output\typed.sc: 953.9
        /** Factory creating iceberg orders
         *
         *  Iceberg order is initialized by an underlying order and a lot size.
         *  It sends consequently pieces of the underlying order of size equal or less to the lot size
        ...
        // defined at .output\typed.sc: 964.9
        /** Factory creating Immediate-Or-Cancel orders
         *
         *  Immediate-Or-Cancel order sends an underlying order to the market and
         *  immediately sends a cancel request for it.
        ...
        // defined at .output\typed.sc: 977.9
        /** Factory creating WithExpiry orders
         *
         * WithExpiry orders can be viewed as ImmediateOrCancel orders
         * where cancel order is sent not immediately but after some delay
        ...
        // defined at .output\typed.sc: 1022.9
        /** Factory creating StopLoss orders
         *
         *  StopLoss order is initialised by an underlying order and a maximal acceptable loss factor.
         *  It keeps track of position and balance change induced by trades of the underlying order and
        ...
        // defined at .output\typed.sc: 1044.9
        /** Factory creating StopLoss orders
         *
         *  StopLoss order is initialised by an underlying order and a maximal acceptable loss factor.
         *  It keeps track of position and balance change induced by trades of the underlying order and
        ...
        // defined at .output\typed.sc: 1056.9
        /** Factory creating WithExpiry orders
         *
         * WithExpiry orders can be viewed as ImmediateOrCancel orders
         * where cancel order is sent not immediately but after some delay
        ...
        // defined at .output\typed.sc: 1066.9
        /** Factory creating WithExpiry orders
         *
         * WithExpiry orders can be viewed as ImmediateOrCancel orders
         * where cancel order is sent not immediately but after some delay
        ...
        // defined at .output\typed.sc: 1076.9
        /** Factory creating Immediate-Or-Cancel orders
         *
         *  Immediate-Or-Cancel order sends an underlying order to the market and
         *  immediately sends a cancel request for it.
        ...
        // defined at .output\typed.sc: 1089.9
        /** Factory creating orders with floating price
         *
         *  Floating price order is initialized by an order having a price and an observable that generates new prices.
         *  When the observable value changes the order is cancelled and
        ...
        // defined at .output\typed.sc: 1100.9
        ...
        // defined at .output\typed.sc: 1108.9
        /** Factory creating StopLoss orders
         *
         *  StopLoss order is initialised by an underlying order and a maximal acceptable loss factor.
         *  It keeps track of position and balance change induced by trades of the underlying order and
        ...
        // defined at .output\typed.sc: 1144.9
        /** Factory creating orders with floating price
         *
         *  Floating price order is initialized by an order having a price and an observable that generates new prices.
         *  When the observable value changes the order is cancelled and
        ...
        // defined at .output\typed.sc: 1155.9
        /** Factory creating orders with floating price
         *
         *  Floating price order is initialized by an order having a price and an observable that generates new prices.
         *  When the observable value changes the order is cancelled and
        ...
        // defined at .output\typed.sc: 1166.9
        /** Factory creating WithExpiry orders
         *
         * WithExpiry orders can be viewed as ImmediateOrCancel orders
         * where cancel order is sent not immediately but after some delay
        ...
        // defined at .output\typed.sc: 1176.9
        /** Factory creating limit orders
         *
         *  Limit orders ask to buy or sell some asset at price better than some limit price.
         *  If a limit order is not competely fulfilled
        ...
        // defined at .output\typed.sc: 1186.9
        /** Factory creating iceberg orders
         *
         *  Iceberg order is initialized by an underlying order and a lot size.
         *  It sends consequently pieces of the underlying order of size equal or less to the lot size
        ...
        // defined at .output\typed.sc: 1197.9
        /** Factory creating orders with floating price
         *
         *  Floating price order is initialized by an order having a price and an observable that generates new prices.
         *  When the observable value changes the order is cancelled and
        ...
        // defined at .output\typed.sc: 1208.9
        /** Factory creating market orders
         *
         *  Market order intructs buy or sell given volume immediately
         */
        ...
        // defined at .output\typed.sc: 1227.9
        /** Factory creating orders with floating price
         *
         *  Floating price order is initialized by an order having a price and an observable that generates new prices.
         *  When the observable value changes the order is cancelled and
        ...
        // defined at .output\typed.sc: 1238.9
        /** Factory creating WithExpiry orders
         *
         * WithExpiry orders can be viewed as ImmediateOrCancel orders
         * where cancel order is sent not immediately but after some delay
        ...
        // defined at .output\typed.sc: 1248.9
        /** Factory creating iceberg orders
         *
         *  Iceberg order is initialized by an underlying order and a lot size.
         *  It sends consequently pieces of the underlying order of size equal or less to the lot size
        ...
        // defined at .output\typed.sc: 1259.9
        /** Factory creating orders with floating price
         *
         *  Floating price order is initialized by an order having a price and an observable that generates new prices.
         *  When the observable value changes the order is cancelled and
        ...
        // defined at .output\typed.sc: 1270.9
        /** Factory creating Immediate-Or-Cancel orders
         *
         *  Immediate-Or-Cancel order sends an underlying order to the market and
         *  immediately sends a cancel request for it.
        ...
        // defined at .output\typed.sc: 1283.9
        /** Factory creating market orders
         *
         *  Market order intructs buy or sell given volume immediately
         */
        ...
        // defined at .output\typed.sc: 1302.9
        /** Factory creating limit orders
         *
         *  Limit orders ask to buy or sell some asset at price better than some limit price.
         *  If a limit order is not competely fulfilled
        ...
        // defined at .output\typed.sc: 1342.9
        /** Factory creating Immediate-Or-Cancel orders
         *
         *  Immediate-Or-Cancel order sends an underlying order to the market and
         *  immediately sends a cancel request for it.
        ...
        // defined at .output\typed.sc: 1366.9
        /** Factory creating iceberg orders
         *
         *  Iceberg order is initialized by an underlying order and a lot size.
         *  It sends consequently pieces of the underlying order of size equal or less to the lot size
        ...
        // defined at .output\typed.sc: 1377.9
        /** Factory creating limit orders
         *
         *  Limit orders ask to buy or sell some asset at price better than some limit price.
         *  If a limit order is not competely fulfilled
    ...
    // defined at .output\typed.sc: 1424.5
    /** Factory creating limit orders
     *
     *  Limit orders ask to buy or sell some asset at price better than some limit price.
     *  If a limit order is not competely fulfilled
    ...
    // defined at .output\typed.sc: 1436.5
    /** Factory creating market orders
     *
     *  Market order intructs buy or sell given volume immediately
     */
    ...
    // defined at .output\typed.sc: 1444.5
    /** Factory creating Immediate-Or-Cancel orders
     *
     *  Immediate-Or-Cancel order sends an underlying order to the market and
     *  immediately sends a cancel request for it.
    ...
    // defined at .output\typed.sc: 1457.5
    /** Factory creating market orders
     *
     *  Market order intructs buy or sell given volume immediately
     */
    ...
    // defined at .output\typed.sc: 1466.5
    /** Factory creating StopLoss orders
     *
     *  StopLoss order is initialised by an underlying order and a maximal acceptable loss factor.
     *  It keeps track of position and balance change induced by trades of the underlying order and
    ...
    // defined at .output\typed.sc: 1478.5
    /** Factory creating WithExpiry orders
     *
     * WithExpiry orders can be viewed as ImmediateOrCancel orders
     * where cancel order is sent not immediately but after some delay
    ...
    // defined at .output\typed.sc: 1488.5
    /** Factory creating orders with floating price
     *
     *  Floating price order is initialized by an order having a price and an observable that generates new prices.
     *  When the observable value changes the order is cancelled and
    ...
    // defined at .output\typed.sc: 1499.5
    /** Factory creating iceberg orders
     *
     *  Iceberg order is initialized by an underlying order and a lot size.
     *  It sends consequently pieces of the underlying order of size equal or less to the lot size
    ...
    // defined at .output\typed.sc: 1510.5
    /** Factory creating fixed budget orders
     *
     *  Fixed budget order acts like a market order
     *  but the volume is implicitly given by a budget available for trades.
    ...
    // defined at .output\typed.sc: 1524.5
    /** Factory creating limit orders
     *
     *  Limit orders ask to buy or sell some asset at price better than some limit price.
     *  If a limit order is not competely fulfilled
    ...
    // defined at .output\typed.sc: 1535.5
    /** Factory creating Peg orders
     *
     *  A peg order is a particular case of the floating price order
     *  with the price better at one tick than the best price of the order queue.
...
package strategy {@category = "Side function"
    ...
    package side {
        // defined at .output\typed.sc: 1552.9
        ...
        def PairTrading(/** reference to order book for another asset used to evaluate fair price of our asset */ bookToDependOn : Optional[.IOrderBook] = .orderbook.OfTrader(),
                        ...
                        /** asset in question */ book : Optional[.IOrderBook] = .orderbook.OfTrader()) : .IObservable[.Side] = .observable.Side(.strategy.side.FundamentalValue(.ops.Mul(.orderbook.MidPrice(bookToDependOn),.constant(factor)),book))
        
        // defined at .output\typed.sc: 1560.9
        /** Side function for signal strategy
         */
        @python.observable()
        def Signal(/** signal to be listened to */ signal : Optional[.IFunction[.Float]] = .constant(0.0),
                   /** threshold when the trader starts to act */ threshold : Optional[.Float] = 0.7) : .IFunction[.Side] = .ops.Condition_Side(.ops.Greater(signal,.constant(threshold)),.side.Buy(),.ops.Condition_Side(.ops.Less(signal,.constant(0-threshold)),.side.Sell(),.side.Nothing()))
        
        // defined at .output\typed.sc: 1568.9
        ...
        // defined at .output\typed.sc: 1585.9
        ...
        // defined at .output\typed.sc: 1593.9
        ...
        // defined at .output\typed.sc: 1600.9
        /** Side function for a noise trading strategy
         */
        def Noise(side_distribution : Optional[() => .Float] = .math.random.uniform(0.0,1.0)) : .IFunction[.Side] = .ops.Condition_Side(.ops.Greater(side_distribution,.constant(0.5)),.side.Sell(),.side.Buy())
    }
    ...
    package weight {
        package array {
            ...
            // defined at .output\typed.sc: 1616.13
        ...
        package trader {
            ...
            // defined at .output\typed.sc: 1638.13
            ...
            // defined at .output\typed.sc: 1647.13
        ...
        package f {
            ...
            // defined at .output\typed.sc: 1668.13
        ...
        // defined at .output\typed.sc: 1677.9
        /** Function returning an array of length *len(array)*
         *  having 1 at the index of the maximal element and 0 are at the rest
         */
        ...
        // defined at .output\typed.sc: 1691.9
        /** Returns traders eficiency. Under efficiency we understand trader balance if trader position was cleared
         */
        @curried("trader")
        ...
        // defined at .output\typed.sc: 1719.9
        /** Returns first derivative of a moving average of the trader efficiency
         */
        @curried("trader")
        ...
        // defined at .output\typed.sc: 1744.9
        /** Identity function for an array of floats
         */
        ...
        // defined at .output\typed.sc: 1753.9
        /** identity scaling = f(x)
         */
        @curried("f")
    ...
    package price {
        // defined at .output\typed.sc: 1764.9
    ...
    package position {
        // defined at .output\typed.sc: 1778.9
        ...
        // defined at .output\typed.sc: 1785.9
        ...
        def RSI_linear(/** alpha parameter for exponentially moving averages of up movements and down movements */ alpha : Optional[.Float] = 1.0/14.0,
                       ...
                       /** trader in question */ trader : Optional[.ISingleAssetTrader] = .trader.SingleProxy()) : .IObservable[.Volume] = .strategy.position.DesiredPosition(.observable.OnEveryDt(1.0,.ops.Mul(.ops.Sub(.constant(50.0),.math.RSI(.orderbook.OfTrader(trader),timeframe,alpha)),k)),trader)
        
        // defined at .output\typed.sc: 1794.9
    ...
    package account {
        package inner {
            // defined at .output\typed.sc: 1806.13
        ...
        // defined at .output\typed.sc: 1831.9
        /** Associated with a strategy account that evaluates for every order sent by the strategy
         *  how it would be traded by sending request.evalMarketOrder
         *  (note: orders sent by a strategy wrapped into an adaptive strategy may not come to the market
         *  but we want evaluate in any case would it be profitable or not)
    ...
    // defined at .output\typed.sc: 1846.5
    ...
    // defined at .output\typed.sc: 1854.5
    ...
    // defined at .output\typed.sc: 1863.5
    ...
    // defined at .output\typed.sc: 1877.5
    ...
    // defined at .output\typed.sc: 1889.5
    ...
    // defined at .output\typed.sc: 1900.5
    ...
    // defined at .output\typed.sc: 1910.5
    ...
    // defined at .output\typed.sc: 1923.5
    ...
    // defined at .output\typed.sc: 1930.5
    ...
    // defined at .output\typed.sc: 1944.5
    ...
    // defined at .output\typed.sc: 1954.5
    ...
    // defined at .output\typed.sc: 1963.5
    ...
    // defined at .output\typed.sc: 1975.5
    ...
    // defined at .output\typed.sc: 1990.5
    ...
    // defined at .output\typed.sc: 2007.5
    /** A composite strategy initialized with an array of strategies.
    ...
    // defined at .output\typed.sc: 2023.5
    ...
    // defined at .output\typed.sc: 2039.5
    ...
    // defined at .output\typed.sc: 2047.5
    ...
    // defined at .output\typed.sc: 2058.5
    ...
    // defined at .output\typed.sc: 2067.5
    ...
    // defined at .output\typed.sc: 2071.5
    ...
    // defined at .output\typed.sc: 2078.5
...
package trader {
    ...
    // defined at .output\typed.sc: 2096.5
    ...
    // defined at .output\typed.sc: 2103.5
    ...
    // defined at .output\typed.sc: 2117.5
    ...
    // defined at .output\typed.sc: 2125.5
    ...
    // defined at .output\typed.sc: 2138.5
    /** Returns first derivative of a moving average of the trader efficiency
     */
    ...
    // defined at .output\typed.sc: 2151.5
...
package orderbook {@queue = "Ask_{%(book)s}"
    ...
    package ask {
        ...
        // defined at .output\typed.sc: 2175.9
        ...
        // defined at .output\typed.sc: 2192.9
    ...
    package bid {
        ...
        // defined at .output\typed.sc: 2207.9
        @label = "LastTradeVolume({{queue}})"
        ...
        // defined at .output\typed.sc: 2224.9
        @label = "LastTrade({{queue}})"
    ...
    // defined at .output\typed.sc: 2230.5
    ...
    // defined at .output\typed.sc: 2239.5
    ...
    // defined at .output\typed.sc: 2248.5
     ...
     */
    def MidPrice(book : Optional[.IOrderBook] = .orderbook.OfTrader()) : .IObservable[.Price] = .observable.Price(.ops.Div(.ops.Add(.orderbook.ask.Price(book),.orderbook.bid.Price(book)),.constant(2.0)))
    
    // defined at .output\typed.sc: 2268.5
    ...
    // defined at .output\typed.sc: 2275.5
    ...
    // defined at .output\typed.sc: 2282.5
    ...
    // defined at .output\typed.sc: 2289.5
    ...
    // defined at .output\typed.sc: 2306.5
    ...
    // defined at .output\typed.sc: 2313.5
    ...
    // defined at .output\typed.sc: 2335.5
    ...
    // defined at .output\typed.sc: 2345.5
    ...
    // defined at .output\typed.sc: 2352.5
    ...
    // defined at .output\typed.sc: 2363.5
    ...
    // defined at .output\typed.sc: 2373.5
    ...
    def NaiveCumulativePrice(book : Optional[.IOrderBook] = .orderbook.OfTrader(),
                             depth : Optional[.IFunction[.Float]] = .constant()) : .IObservable[.Price] = .observable.Price(.ops.Condition_Float(.ops.Less(depth,.constant(0.0)),.ops.Mul(depth,.orderbook.ask.Price(book)),.ops.Condition_Float(.ops.Greater(depth,.constant(0.0)),.ops.Mul(depth,.orderbook.bid.Price(book)),.constant(0.0))))
    
    // defined at .output\typed.sc: 2384.5
    ...
    // defined at .output\typed.sc: 2399.5
...
package observable {
    // defined at .output\typed.sc: 2410.5
    ...
    // defined at .output\typed.sc: 2419.5
    ...
    // defined at .output\typed.sc: 2427.5
    ...
    // defined at .output\typed.sc: 2435.5
    ...
    // defined at .output\typed.sc: 2443.5
    ...
    // defined at .output\typed.sc: 2450.5
    ...
    // defined at .output\typed.sc: 2458.5
...
package trash {
    ...
    package overloading {
        // defined at .output\typed.sc: 2526.9
        def f(x : .IFunction[.Volume]) : .IFunction[.Volume] = x
        
        // defined at .output\typed.sc: 2530.9
        def f(x : .IFunction[.Float]) : .IFunction[.Float] = x
        
        // defined at .output\typed.sc: 2534.9
        def f(x : .IFunction[.Price]) : .IFunction[.Price] = x
        
        // defined at .output\typed.sc: 2538.9
        def g(x : .IFunction[.Volume]) : .IFunction[.Volume] = .trash.overloading.f(x)
        
        // defined at .output\typed.sc: 2542.9
        def h() : .IFunction[.Float] = .trash.overloading.f(.constant(12))
    }
    
    // defined at .output\typed.sc: 2547.5
...
// defined at .output\typed.sc: 2578.1
...
// defined at .output\typed.sc: 2586.1
...
// defined at .output\typed.sc: 2594.1
...
// defined at .output\typed.sc: 2601.1
...
// defined at .output\typed.sc: 2613.1
...
// defined at .output\typed.sc: 2621.1
...
// defined at .output\typed.sc: 2631.1
...
// defined at .output\typed.sc: 2639.1
...
// defined at .output\typed.sc: 2649.1
