...
The library source can be found at \url{http://marketsimulator.svn.sourceforge.net/viewvc/marketsimulator/DevAnton/v3/}. It requires Python 2.7 installed. For graph plotting free \tmtexttt{Veusz} plotting software is needed and it can be found in \tmtexttt{Python(x,y)} scientific Python distributive: \url{http://code.google.com/p/pythonxy/}. \tmtexttt{ArbitrageTrader} needs free \tmtexttt{blist} package to be installed: \url{http://pypi.python.org/pypi/blist/}.
