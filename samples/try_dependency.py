...
def Dependency(graph, world, books):
    ...
    dep_AB_ex = trader.SASM(book_A, strategy.DependencyEx(book_B, factor=2), "A dependent on B ex")
    dep_BA_ex = trader.SASM(book_B, strategy.DependencyEx(book_A, factor=.5), "B dependent on A ex")
