...
def TwoAverages(graph, world, books):
    ...
    avg_ex_plus = trader.SASM(book_A, strategy.TwoAveragesEx(average1 = slow, average2 = fast), 'avg_ex+')
    avg_ex_minus = trader.SASM(book_A, strategy.TwoAveragesEx(average1 = fast, average2 = slow), 'avg_ex-')
